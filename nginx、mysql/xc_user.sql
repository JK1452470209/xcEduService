...
MySQL - 5.7.27-log : Database - xc_user
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`xc_user` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
insert  into `xc_user`(`id`,`username`,`password`,`salt`,`name`,`userpic`,`utype`,`birthday`,`sex`,`email`,`phone`,`qq`,`status`,`create_time`,`update_time`) values ('46','super','$2a$10$TJ4TmCdK.X4wv/tCqHW14.w70U3CC33CeVncD3SLmyMXMknstqKRe',NULL,'超级管理员',NULL,'101003',NULL,'1',NULL,NULL,NULL,'1','2018-03-07 16:27:47',NULL),('48','admin','$2a$10$TJ4TmCdK.X4wv/tCqHW14.w70U3CC33CeVncD3SLmyMXMknstqKRe',NULL,'系统管理员',NULL,'101003',NULL,'1',NULL,NULL,NULL,'1','2018-03-07 16:27:47',NULL),('49','itcast','$2a$10$TJ4TmCdK.X4wv/tCqHW14.w70U3CC33CeVncD3SLmyMXMknstqKRe',NULL,'测试账号',NULL,'101002',NULL,'1','','12345',NULL,'1','2018-03-07 16:27:47',NULL),('50','stu1','$2a$10$pLtt2KDAFpwTWLjNsmTEi.oU1yOZyIn9XkziK/y/spH5rftCpUMZa',NULL,'学生1',NULL,'101001',NULL,'1',NULL,NULL,NULL,'1','2018-03-07 16:27:47',NULL),('51','stu2','$2a$10$nxPKkYSez7uz2YQYUnwhR.z57km3yqKn3Hr/p1FR6ZKgc18u.Tvqm',NULL,'学生2',NULL,'101001',NULL,'1',NULL,NULL,NULL,'1','2018-03-07 16:27:47',NULL),('52','t1','$2a$10$TJ4TmCdK.X4wv/tCqHW14.w70U3CC33CeVncD3SLmyMXMknstqKRe',NULL,'老师1',NULL,'101002',NULL,'1',NULL,NULL,NULL,'','2018-03-07 16:27:47',NULL);
...
insert  into `xc_user_role`(`id`,`user_id`,`role_id`,`create_time`,`creator`) values ('1','46','8','2017-09-11 13:02:45','超级管理员'),('19','50','6','2017-09-12 14:20:20','超级管理员'),('2','48','6','2017-09-11 13:02:56','超级管理员'),('20','50','17','2017-09-12 14:20:20','超级管理员'),('21','52','20',NULL,NULL),('3','49','20','2017-09-11 13:03:12','');
